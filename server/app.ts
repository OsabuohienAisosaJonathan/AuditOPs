...
export const initPromise = (async () => {
    ...
    if (process.env.NODE_ENV === "production") {
        ...
        // const { setupVite } = await import("./vite"); // Cannot easily import dynamically in commonjs export?
        // Actually this file is ts, compiled to cjs.
        // We are maintaining the logic.
